...
/***/ "./frontend/modules/VerifyIsFile.js":
/*!******************************************!*\
  !*** ./frontend/modules/VerifyIsFile.js ***!
  \******************************************/
...
/* harmony export */   "default": () => (/* binding */ ValidFiles)
/* harmony export */ });
...
var ValidFiles = /*#__PURE__*/function () {
  function ValidFiles(formFiles) {
    _classCallCheck(this, ValidFiles);
    this.form = document.querySelector(formFiles);
    console.log('Execute');
  }
  _createClass(ValidFiles, [{
    key: "init",
    value: function init() {
      this.event();
    }
    ...
    value: function valida(e) {
      ...
      var filesPermi = confirm('This image your that select?');
...
/* harmony import */ var _modules_VerifyIsFile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/VerifyIsFile */ "./frontend/modules/VerifyIsFile.js");



var files = new _modules_VerifyIsFile__WEBPACK_IMPORTED_MODULE_2__["default"]('.verifyFiles');
files.init();
})();
